...
int main(int argc, char** argv)
{
    ...
    // LOADING THE IMAGE
    char* imageName = "../../../car3.png";
    Mat image;
    image = imread(imageName, IMREAD_COLOR); if (image.empty()) { return -1; }
    ...
    {
    WienerDeconvoluition(gray_image, recover1[i], 15, 3+0.2*i, 0.001 - 0.0002*i, 0);
    showImage(to_string(i), recover1[i]);
    }
